...
use crate::kit::{ControllerFrameBuilder, ControllerView, metric};
use crate::terminal::{
...
impl TransferPdgController {
    ...
    fn update_transfer_frame(
        ...
        insert_waypoint_metrics(&mut frame, waypoint_telemetry);
        frame
    }
    ...
    fn update_active_waypoint_frame(
        ...
        insert_waypoint_metrics(&mut frame, Some(telemetry));
