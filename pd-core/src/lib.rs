...
pub use model::{
    ...
    PhysicalOutcome, RunArtifacts, RunContext, RunManifest, RunSummary, SampleRecord,
    ScenarioSpec, SimConfig, VehicleGeometry, VehicleInitialState, VehicleSpec, WorldSpec,
};
